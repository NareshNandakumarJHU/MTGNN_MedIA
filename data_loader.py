...
class data_test(torch.utils.data.Dataset):
    def __init__(self, transform=False, class_balancing=False,index=0):
        ...
        stringX = 'x_' + str(index) + '.mat'
        X_str = 'x_' + str(index)

        stringY_L = 'y_L' + str(index) + '.mat'
        Y_str_L = 'y_L' + str(index)

        stringY_Fi = 'y_Fi' + str(index) + '.mat'
        Y_str_Fi = 'y_Fi' + str(index)

        stringY_Fo = 'y_Fo' + str(index) + '.mat'
        Y_str_Fo = 'y_Fo' + str(index)

        stringY_T = 'y_T' + str(index) + '.mat'
...
class data_train(torch.utils.data.Dataset):
    def __init__(self, transform=False, class_balancing=False,index=0,fold=1):
        ...
        for i in folds_index:
            stringX = 'x_' + str(i) + '.mat'
            X_str = 'x_' + str(i)

            stringY_L = 'y_L' + str(i) + '.mat'
            Y_str_L = 'y_L' + str(i)

            stringY_Fi = 'y_Fi' + str(i) + '.mat'
            Y_str_Fi = 'y_Fi' + str(i)

            stringY_Fo = 'y_Fo' + str(i) + '.mat'
            Y_str_Fo = 'y_Fo' + str(i)

            stringY_T = 'y_T' + str(i) + '.mat'
            Y_str_T = 'y_T' + str(i)
